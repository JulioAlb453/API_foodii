...
function registerRoutes(app, deps) {
    ...
    app.post("/api/auth/verify-token", (req, res) => authController.verifyTokenFromBody(req, res));
    app.get("/api/auth/health", (req, res) => authController.authHealth(req, res));
    ...
    app.get("/api/ingredients", authMiddleware, (req, res) => ingredientController.getAll(req, res));
    app.get("/api/ingredients/search", authMiddleware, (req, res) => ingredientController.search(req, res));
    app.post("/api/ingredients/calculate-calories", authMiddleware, (req, res) => ingredientController.calculateCalories(req, res));
    app.post("/api/ingredients/calculate-bulk-calories", authMiddleware, (req, res) => ingredientController.calculateBulkCalories(req, res));
