...
CREATE TABLE IF NOT EXISTS meals (
  ...
  image          VARCHAR(500)  NULL COMMENT 'ruta de la imagen del platillo',
  PRIMARY KEY (id),
...
-- ---------------------------------------------
-- Tabla: meal_steps (instrucciones de preparación, ordenadas)
-- ---------------------------------------------
...
-- ---------------------------------------------
-- Tabla: meal_categories (slugs por comida)
-- ---------------------------------------------
